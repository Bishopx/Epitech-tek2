...
(* Common func *)
let capitalize_surname _surname =
...
let make_contact (_surname, _name, _age, _mail, _phone, _nickname, _birthday) except = 
...
let rec field_all_bool field str = function
    ...
    | h::t when (strstr (String.lowercase h.nickname) (String.lowercase str) && (field == Nickname || field == All)) -> true
    | h::t when (strstr (String.lowercase h.birthday) (String.lowercase str) && (field == Birthday || field == All)) -> true
...
let rec field_all field str i = function
    ...
    | h::t when (strstr (String.lowercase h.nickname) (String.lowercase str) &&
                (field == Nickname || field == All)) && field_all_bool field str t == false -> i
    | h::t when (strstr (String.lowercase h.birthday) (String.lowercase str) &&
                (field == Birthday || field == All)) && field_all_bool field str t == false -> i
...
let print_one id contact = 
    ...
    print_field contact.phone 17;
    print_field contact.nickname 16;
    print_field contact.birthday 8;
    print_string "\n"
;;
...
let get_list_field contact field str = 
    ...
    else if strstr (String.lowercase contact.nickname) (String.lowercase str) && (field == Nickname || field == All) then true
    else if strstr (String.lowercase contact.birthday) (String.lowercase str) && (field == Birthday || field == All) then true
...
module Contact : ICONTACT = 
    struct
        ...
        let add contact_list (_surname, _name, _age, _mail, _phone, _nickname, _birthday) = 
            contact_list@[make_contact (_surname, _name, _age, _mail, _phone, _nickname, _birthday) Add_Contact_With_Invalid_Data]
        ;;
        ...
        let replace contact_list id (_surname, _name, _age, _mail, _phone, _nickname, _birthday) = match contact_list with
            ...
            | _ ->
                ...
                contact = make_contact (_surname, _name, _age, _mail, _phone, _nickname, _birthday) Replace_Contact_With_Invalid_Data in
